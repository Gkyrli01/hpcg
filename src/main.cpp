...
int main(int argc, char *argv[]) {
	...
	GenerateGeometry(size, rank, params.numThreads, params.pz, params.zl, params.zu, nx, ny, nz, params.npx, params.npy,
					 params.npz, geom);
	...
	InitializeVector(x_overlap, ncol, ncol); // Overlapped copy of x vector
	InitializeVector(b_computed, nrow, nrow + (64 - nrow % 64) * (nrow % 64 != 0)); // Computed RHS vector
